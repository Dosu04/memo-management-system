...
public class IssueReportControllerUser {

    private final IssueReportService issueReportService;
    private final UserService userService;

    @Autowired
    public IssueReportControllerUser(IssueReportService issueReportService, UserService userService) {

...
@Controller
@RequestMapping("/dean/issues")
public class IssueReportControllerDean {

    private final IssueReportService issueReportService;
    private final UserService userService;

    @Autowired
    public IssueReportControllerDean(IssueReportService issueReportService, UserService userService) {

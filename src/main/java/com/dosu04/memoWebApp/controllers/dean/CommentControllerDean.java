...
@Controller
@RequestMapping("/dean/memos/view/{memoId}")
public class CommentControllerDean {
    private final CommentService commentService;

    @Autowired
    public CommentControllerDean(CommentService commentService) {
    ...
    public String addComment(@PathVariable Long memoId, @RequestParam String content, Principal principal, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/dean/memos/view/{memoId}";
